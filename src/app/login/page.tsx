    ...
    <div style={{
      ...
      <div style={{ width: "100%", maxWidth: 400 }}>
        ...
        <div style={{ display: "flex", flexDirection: "column", gap: 10, marginBottom: 24 }}>
          <button
            onClick={() => { if (oauthLoading) return; setOauthLoading("google"); signIn("google", { callbackUrl: "/home" }); }}
          ...
          <button
            onClick={() => { if (oauthLoading) return; setOauthLoading("github"); signIn("github", { callbackUrl: "/home" }); }}
            disabled={!!oauthLoading}
            style={{
              height: 48, borderRadius: 12, border: `0.5px solid ${T.borderStrong}`,
              background: T.surface, color: T.text, fontSize: 14, fontWeight: 500,
